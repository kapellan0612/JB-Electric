...
import heroElectricianMobile from '../assets/hero-electrician-mobile.png';
    ...
    <div style={styles.root}>
      <div style={styles.hero}>
        ...
        >
          ...
          />
          <img
            className={`jb-hero-photo jb-hero-photo-mobile ${photoLoaded ? 'jb-img-loaded' : ''}`}
            src={heroElectricianMobile}
            alt=""
            style={{ ...styles.photoImg, opacity: photoLoaded ? undefined : 0 }}
          />
        </div>

        {/* Left navy gradient overlay — desktop only; mobile photo has its own gradient baked in */}
