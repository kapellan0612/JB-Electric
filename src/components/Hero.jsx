        ...
        <div className="jb-grid-hero jb-section-px" style={styles.inner}>
          ...
          <div style={styles.content}>
            ...
            <div className="jb-hero-fade d8" style={styles.actions}>
              ...
              <button className="jb-btn-arrow" style={styles.btnSecondary} onClick={() => navigate('/services')}>
                Or see our services →
              </button>
            </div>
          ...
          <div className="jb-hero-card-hide" style={styles.cardWrap}>
            <div className="jb-hero-card-in d9" style={styles.card}>
              ...
              <button className="jb-btn-lift jb-btn-arrow" style={styles.cardCta} onClick={() => navigate('/contact')}>
                Schedule Service →
              </button>
            </div>
          </div>
